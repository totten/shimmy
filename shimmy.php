 ...
 */
function shimmy_civicrm_xmlMenu(&$files) {
  _shimmy_civix_civicrm_xmlMenu($files);
}
 ...
 */
function shimmy_civicrm_managed(&$entities) {
  _shimmy_civix_civicrm_managed($entities);
}
 ...
 */
function shimmy_civicrm_caseTypes(&$caseTypes) {
  _shimmy_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function shimmy_civicrm_angularModules(&$angularModules) {
  _shimmy_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function shimmy_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  _shimmy_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
 ...
 */
function shimmy_civicrm_themes(&$themes) {
  _shimmy_civix_civicrm_themes($themes);
}
